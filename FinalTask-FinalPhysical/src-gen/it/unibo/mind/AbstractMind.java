		...
		*/    
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	temporaryStr = "\"mind START APPLICATION \"";
	    	println( temporaryStr );  
	    	{
	    	String tStr1 = "robotState(_)";
	    	...
	    	emit( "robotState", temporaryStr );
	    	temporaryStr = QActorUtils.unifyMsgContent(pengine,"cellValue(X,Y,S)","cellValue(0,0,1)", guardVars ).toString();
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("nextMove",-1);
	    	...
	    	if( currentMessage != null && currentMessage.msgId().equals("moveAction") && 
	    		...
	    		it.unibo.utils.movePlanUtil.move( myself ,"w", guardVars.get("T")  );
	    		}
	    		};//actionseq
	    	}
	    	//onMsg 
