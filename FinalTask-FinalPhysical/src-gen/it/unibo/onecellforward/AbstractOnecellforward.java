		...
		*/    
	    ...
	    try{	
	     ...
	     msgTransition( pr,myselfName,"onecellforward_"+myselfName,false,
	          ...
	          new String[]{"true","M","haltAppl", "true","M","moveMsgCmd" },
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("startWork",-1);
	    	...
	    	temporaryStr = "\"Trying to go ahead\"";
	    	...
	    	sendMsg("robotCmd","player", QActorContext.dispatch, temporaryStr ); 
	    	}
	    	//bbb
	     msgTransition( pr,myselfName,"onecellforward_"+myselfName,false,
	          new StateFun[]{stateTab.get("handleStop"), stateTab.get("probableFixedObstacle") }, 
	          new String[]{"true","M","haltAppl", "true","M","collisionDispatch" },
	          900, "endMoveForward" );//msgTransition
	    ...
	    try{	
	     ...
	     msgTransition( pr,myselfName,"onecellforward_"+myselfName,false,
	          ...
	          new String[]{"true","M","haltAppl", "true","M","collisionDispatch", "true","M","obstacleNear" },
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("endMoveForward",-1);
	    	...
	    	sendMsg("robotCmd","player", QActorContext.dispatch, temporaryStr ); 
	    	it.unibo.utils.movePlanUtil.getDuration( myself  );
	    	if( (guardVars = QActorUtils.evalTheGuard(this, " !?moveTimeInfo(TF,TD)" )) != null ){
	    	temporaryStr = "moveMsgCmdDone(TD)";
	    	temporaryStr = QActorUtils.substituteVars(guardVars,temporaryStr );
