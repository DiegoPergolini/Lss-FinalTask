...
public abstract class AbstractEvhrobotstate extends EventHandlerComponent { 
protected IEventItem event;
	public AbstractEvhrobotstate(String name, QActorContext myCtx, IOutputEnvView outEnvView, String[] eventIds ) throws Exception {
	...
	public void handleCurrentEvent() throws Exception {
		...
		Term msgPattern = Term.createTerm("robotState(V)");
				boolean b = this.pengine.unify(msgt, msgPattern);
				if( b ) {
			  		sendMsg("robotChangeState","worldobserver", QActorContext.dispatch, msgt.toString() ); 
				}else{
