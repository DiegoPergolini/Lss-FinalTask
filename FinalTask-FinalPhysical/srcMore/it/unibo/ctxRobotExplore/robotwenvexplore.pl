...
%====================================================================================
pubsubserveraddr("tcp://192.168.43.137:1883").
pubsubsystopic("unibo/qasys").
%%% -------------------------------------------
context(ctxrobotexplore, "192.168.43.19",  "TCP", "8028" ).  		 
context(ctxrobotretriever, "192.168.43.19",  "TCP", "8100" ).  		 
%%% -------------------------------------------
...
%%% -------------------------------------------
eventhandler(collisionevh,ctxrobotexplore,"it.unibo.ctxRobotExplore.Collisionevh","sonarDetect").  
eventhandler(evhtemperaturestate,ctxrobotexplore,"it.unibo.ctxRobotExplore.Evhtemperaturestate","temperatureState").  
eventhandler(evhrobotstate,ctxrobotexplore,"it.unibo.ctxRobotExplore.Evhrobotstate","robotState").  
eventhandler(evhinvcondition,ctxrobotexplore,"it.unibo.ctxRobotExplore.Evhinvcondition","invalidCondition").  
eventhandler(evhvalcondition,ctxrobotexplore,"it.unibo.ctxRobotExplore.Evhvalcondition","validCondition").  
%%% -------------------------------------------
