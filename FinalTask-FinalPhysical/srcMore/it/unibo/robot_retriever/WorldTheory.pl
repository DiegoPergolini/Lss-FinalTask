%==============================================
% WorldTheory.pl for actor robot_retriever
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturobot_retriever).	%%old version (deprecated)
actorobj(qaturobot_retriever).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor robot_retriever
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of robot_retriever" ). 
...
%-------------------------------------------------
%  User static rules about robot_retriever
%------------------------------------------------- 
timew( 900).
timeTurn( 1000).
eval( eq,X,X).
