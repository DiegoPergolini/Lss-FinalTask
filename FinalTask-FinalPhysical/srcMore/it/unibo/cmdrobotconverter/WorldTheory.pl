%==============================================
% WorldTheory.pl for actor cmdrobotconverter
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatucmdrobotconverter).	%%old version (deprecated)
actorobj(qatucmdrobotconverter).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor cmdrobotconverter
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of cmdrobotconverter" ). 
...
%-------------------------------------------------
%  User static rules about cmdrobotconverter
%------------------------------------------------- 
/*
------------------------------------------------------------------------
