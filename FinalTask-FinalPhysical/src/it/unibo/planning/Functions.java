...
//		System.out.println("Cell: "+state.getY()+","+state.getX());
//		System.out.println(RoomMap.getRoomMap().canMove(state.getX(), state.getY(), state.getDirection(),Strategy.ENTERPRISING));
		if (RoomMap.getRoomMap().canMove(state.getX(), state.getY(), state.getDirection(),Strategy.ENTERPRISING))
...
//		if (RoomMap.getRoomMap().isDirty(state.getX(), state.getY()) &&
				if(state.getX()==planUtil.goalX && state.getY() ==planUtil.goalY && 
