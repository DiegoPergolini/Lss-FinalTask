/*
 * it.unibo.mbot2018/nodeCode/robotFrontend/appServer/plugins/coapPlugin.js
 */
var 
...
exports.start = function (params, app) {
  localParams = params;
  configure(app);
  	console.log("coapPlugin start " );
  	console.log( app );	//undefined (by AN)
...
console.log("		coapPlugin (co2 level) LOADED");