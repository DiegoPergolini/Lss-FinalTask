...
public abstract class AbstractPlayer_retriever extends QActor { 
	...
	//protected String mqttServer = "tcp://localhost:1883";
		...
		public AbstractPlayer_retriever(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/player_retriever/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/player_retriever/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "player_retriever tout : stops");  
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	    	...
	    	it.unibo.robotVirtual.basicRobotExecutor.setUp( myself ,"localhost"  );
	    	//delay  ( no more reactive within a plan)
	    	aar = delayReactive(1000,"" , "");
	    	if( aar.getInterrupted() ) curPlanInExec   = "init";
	    	if( ! aar.getGoon() ) return ;
	    	temporaryStr = "\"player retriever STARTS\"";
	    	println( temporaryStr );  
	    	//switchTo cmdIntepreter
	        switchToPlanAsNextState(pr, myselfName, "player_retriever_"+myselfName, 
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"player_retriever_"+myselfName,false,
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("execMove",-1);
	    	...
	    	if( currentMessage != null && currentMessage.msgId().equals("robotCmd") && 
	    		...
	    		//end arg1
	    		String arg2 = "T" ;
	    		arg2 =  updateVars( Term.createTerm("robotCmd(M,T)"), Term.createTerm("robotCmd(M,T)"), 
	    			                Term.createTerm(currentMessage.msgContent()),  arg2 );	                
	    		//end arg2
	    		it.unibo.robotVirtual.basicRobotExecutor.doMove(this,arg1,arg2 );
	    		}
	    	}
	    	repeatPlanNoTransition(pr,myselfName,"player_retriever_"+myselfName,false,true);
