...
public abstract class AbstractCollisionevh extends EventHandlerComponent { 
protected IEventItem event;
	public AbstractCollisionevh(String name, QActorContext myCtx, IOutputEnvView outEnvView, String[] eventIds ) throws Exception {
...
//showMsg( "---------------------------------------------------------------------" );	
		...
		Term msgPattern = Term.createTerm("obstacle(TARGET)");
				boolean b = this.pengine.unify(msgt, msgPattern);
				if( b ) {
			  		sendMsg("collisionDispatch","onecellforward", QActorContext.dispatch, msgt.toString() ); 
				}else{
