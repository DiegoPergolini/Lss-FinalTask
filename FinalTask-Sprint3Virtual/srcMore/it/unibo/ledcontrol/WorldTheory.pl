%==============================================
% WorldTheory.pl for actor ledcontrol
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledcontrol).	%%old version (deprecated)
actorobj(qatuledcontrol).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledcontrol
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledcontrol" ). 
...
%-------------------------------------------------
%  User static rules about ledcontrol
%------------------------------------------------- 
/*
------------------------------------------------------------------------
