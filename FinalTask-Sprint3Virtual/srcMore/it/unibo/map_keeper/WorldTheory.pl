%==============================================
% WorldTheory.pl for actor map_keeper
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumap_keeper).	%%old version (deprecated)
actorobj(qatumap_keeper).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor map_keeper
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of map_keeper" ). 
...
%-------------------------------------------------
%  User static rules about map_keeper
%------------------------------------------------- 
