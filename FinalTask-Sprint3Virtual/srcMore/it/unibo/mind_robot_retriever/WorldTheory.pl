%==============================================
% WorldTheory.pl for actor mind_robot_retriever
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumind_robot_retriever).	%%old version (deprecated)
actorobj(qatumind_robot_retriever).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mind_robot_retriever
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mind_robot_retriever" ). 
...
%-------------------------------------------------
%  User static rules about mind_robot_retriever
%------------------------------------------------- 
timew( 255).
timeTurn( 300).
eval( eq,X,X).
...
doTheFirstMove( w):-timew( T),replaceRule( moveDone( _),moveDone( T)),retract( move( w)), ! .
doTheFirstMove( a):-timeTurn( T),replaceRule( moveDone( _),moveDone( T)),retract( move( a)), ! .
doTheFirstMove( d):-timeTurn( T),replaceRule( moveDone( _),moveDone( T)),retract( move( d)), ! .
/*
------------------------------------------------------------------------
