%==============================================
% WorldTheory.pl for actor player
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuplayer).	%%old version (deprecated)
actorobj(qatuplayer).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor player
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of player" ). 
...
%-------------------------------------------------
%  User static rules about player
%------------------------------------------------- 
/*
------------------------------------------------------------------------
