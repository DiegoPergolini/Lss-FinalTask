...
public class FunctionsConservative implements ActionsFunction, ResultFunction, StepCostFunction, GoalTest {
	...
	public Set<Action> actions(Object arg0) {
		...
		if (RoomMap.getRoomMap().canMove(state.getX(), state.getY(), state.getDirection(),Strategy.CONSERVATIVE))
